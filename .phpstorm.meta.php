...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/apps/laravel-recap/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/apps/laravel-recap/public/storage','logging.default',
...
'debugbar.queries.explain','jobs.index','jobs.create',
'jobs.store','jobs.show','jobs.edit','jobs.update','jobs.destroy','storage.local',);
        registerArgumentsSet('views', 
'about','components.button','components.form-error','components.form-input','components.form-label',
'components.layout','components.nav-link','contact','home','jobs.create',
'jobs.edit','jobs.index','jobs.show','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
